namespace ConsoleTestApp.Features.Hello
{
    ...
    public class HelloView : View<HelloController>
    {
        ...
        public HelloView()
        {
            ...
            form = new Form(
                new Question("What is your first name?", x => Controller.FirstName = x),
                new Question("What is your last name?",  x => Controller.LastName  = x),
                new InputList(
                    "What fruit do you like?",
                    new [] {"Apple", "Banana", "Orange", "Grape", "Kiwi"},
                    x => Controller.Fruit = x ),
                new InputList(
                    ...
                    x => Controller.Country = x ));

            buffer.Header("Hello World");
        ...
        public void AskQuestions()
        {
            ...
            buffer.WriteLine();
            buffer.WriteLine($"Hello, {Controller.FullName}. Welcome to Hello World!");
            buffer.WriteLine($"Eat all the {Controller.Fruit}s you want.");
            buffer.WriteLine($"I am sure you don't get many in {Controller.Country}!");
            Window.Update();
        }
